...
DEPENDENCES="ecb emacs-apel emacs-muse emacs-php-mode emacs-python-mode emacs-slime flim semi wanderlust" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
rm -f ./*.desktop
cp -r archlinux/.junest/usr/share/applications/"$APP".desktop "$APP".AppDir/
LAUNCHER="$APP.AppDir/$APP.desktop"
