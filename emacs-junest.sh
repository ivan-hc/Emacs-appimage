...
$HERE/.local/share/junest/bin/junest -n -b "$ETC_RESOLV" -- $EXEC -q "$@"
EOF
chmod a+x ./AppRun
...
LIBSAVED="pk p11 alsa jack pipewire pulse emacs" # Enter here keywords or file/folder names to save in /usr/lib
